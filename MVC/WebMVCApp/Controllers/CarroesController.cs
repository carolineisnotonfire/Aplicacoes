...
namespace WebMVCApp.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Placa,Ativo,UsuarioCriacao,UsuarioEdicao,DataCriacao,DataEdicao")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Placa,Ativo,UsuarioCriacao,UsuarioEdicao,DataCriacao,DataEdicao")] Carro carro)
        {
            if (ModelState.IsValid)
            {
